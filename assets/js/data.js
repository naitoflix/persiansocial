...
const COMPETITORS = [
  { id: "cmp1", handle: "@casper_smc", role: "REACH", virality: 88, conversion: 25, authority: 40, followers: "573k", verified: true, frequency: "a raffica", lang: "EN",
    types: ["Reel mindset 8-14s", "Testo + audio di tendenza (senza voce)"], pattern: "Frase d'identità a schermo, estetica premium",
    hooks: ["La disciplina batte la motivazione", "Il me del futuro è fiero"], cta: "Quasi assente (reach pura)",
    replicate: ["Reel mindset ultra-corti come motore di reach iniziale"], exclude: ["Assenza totale di CTA/funnel"], note: "132k+ visualizzazioni su reel da 12s. Motore di reach, non converte." },
  { id: "cmp2", handle: "@scotttaylorfx", role: "REACH", virality: 85, conversion: 62, authority: 70, followers: "210k", verified: true, frequency: ">1/giorno", lang: "EN",
    types: ["Motivazionale corto 5-13s", "Educativo / lista di punti"], pattern: "Motivazione (reach) + educazione + meccaniche di engagement",
    hooks: ["Il modo più veloce per fare mesi da 10k", "Le 5 cose che non ti dicono"], cta: "Commenta→DM + esca al salvataggio + segui",
    replicate: ["Commenta→DM → 'Commenta ORO'", "Esca al salvataggio", "Lista '5 cose che non ti dicono'"], exclude: ["Claim di reddito ('mesi da 10k')"], note: "Miglior modello ibrido reach+educazione." },
  { id: "cmp3", handle: "@xauusd.alantrader", role: "GOLD · AUTHORITY", mark: "star", virality: 62, conversion: 70, authority: 88, followers: "1.6k", verified: true, frequency: "quotidiana", lang: "EN",
    types: ["Analisi di mercato 28s (screen del grafico)"], pattern: "Contesto → Bias → Zone → Invalidazione → Spunto",
    hooks: ["L'oro rimbalzerà prima del prossimo crollo?", "L'oro verso un ritracciamento dopo lo sweep di liquidità"], cta: "Commenta ROOM → stanza di ricerca",
    replicate: ["Template 'Analisi di mercato 28s'", "Compliance: 'osserva la reazione, non prevedere'", "Commenta→DM"], exclude: ["Caption troppo tecniche per i principianti", "In inglese, senza volto"], note: "ROLE MODEL GOLD: i suoi reel sull'oro fanno ×5-10 la reach dei suoi forex. La specializzazione paga." },
  { id: "cmp4", handle: "@huss.trades", role: "AUTHORITY", virality: 78, conversion: 60, authority: 82, followers: "38.5k", verified: true, frequency: "ogni 1-2 gg", lang: "EN",
    types: ["Spiegazione di un concetto 20-40s (screen + voce)"], pattern: "Hook curiosità → valore rapido e denso → personalità anti-guru",
    hooks: ["[concetto] spiegato in 30 secondi", "È questo il miglior concetto di trading?"], cta: "Segui per altro contenuto gratis (anti-guru)",
    replicate: ["Format '[concetto] spiegato in 30 secondi'", "Mossa anti-guru 'non vendo corsi'"], exclude: ["Percentuali di win-rate (85%)", "Gergo troppo tecnico"], note: "Miglior insegnante + fiducia grazie all'anti-guru." },
  { id: "cmp5", handle: "@coin.wise.inv", role: "AUTHORITY / FUNNEL", virality: 70, conversion: 85, authority: 55, followers: "64k", verified: false, frequency: "quasi giornaliera", lang: "EN",
    types: ["Spiegazione vocale rapida", "Lifestyle estetico"], pattern: "Valore rapido / vibe → CTA Telegram FISSA su ogni post",
    hooks: ["Timeframe → struttura → liquidità → entrata → target → segui"], cta: "Entra nel mio Telegram — su OGNI post",
    replicate: ["CTA Telegram su ogni singolo post (funnel disciplinato)", "Spiegazione rapida del setup"], exclude: ["Caption identica clonata (uccide reach/SEO)"], note: "Il modello di funnel Telegram più disciplinato del gruppo." },
  { id: "cmp6", handle: "@moneymaxtrades", role: "CONVERSION · NON COPIABILE", mark: "warn", virality: 90, conversion: 75, authority: 50, followers: "16.7k", verified: true, frequency: "quasi giornaliera", lang: "EN",
    types: ["Flex di payout brevi 7-33s", "Screen"], pattern: "Numero-shock + trasparenza sulle perdite + codice copy trading",
    hooks: ["+44.000$ in un giorno", "Preso -17.800$ ma ancora +40k sul mese"], cta: "Segui LIVE + codice copy trading",
    replicate: ["SOLO la struttura dell'hook numerico e la trasparenza sulle perdite, riformulate su rischio/metodo"], exclude: ["Ogni cifra di profitto, il framing 'flex' = 0 compliance per noi e Meta"], note: "Il più virale del gruppo, ma tutta la reach nasce da flex di profitti: intoccabile nel contenuto." },
  { id: "cmp7", handle: "@goldtradingguild", role: "GOLD · AUTHORITY", virality: 55, conversion: 40, authority: 65, followers: "11.5k", verified: false, frequency: "incostante", lang: "EN",
    types: ["Lezioni con esempi numerici 56-69s"], pattern: "Didattica anti-guru ('Uno qualunque che tratta l'oro. Niente corsi')",
    hooks: ["Pareggio vs chiusura parziale: stesso trade, 0$ vs 250$"], cta: "Debole / assente",
    replicate: ["Confronto numerico 'stesso trade, 2 approcci'", "Posizionamento anti-guru"], exclude: ["Reel troppo lunghi", "Output incostante, funnel assente"], note: "Buona didattica, ma non converte." },
  { id: "cmp8", handle: "@cesco.fx", role: "TONO · AUTHORITY", country: "IT", virality: 30, conversion: 55, authority: 80, followers: "12k", verified: false, frequency: "ogni 1-2 gg", lang: "IT",
    types: ["SMC formato lungo 60-176s"], pattern: "Hook-domanda → spiegazione lunga sul grafico → CTA soft compliant",
  ...
  { id: "cmp9", handle: "@ripstrades", role: "REACH / FUNNEL", virality: 35, conversion: 50, authority: 45, followers: "70k", verified: true, frequency: "giornaliera", lang: "EN",
    types: ["Vlog poker + trading (NQ)"], pattern: "Valore gratuito + community, ma diluito dal poker",
    hooks: ["I miei livelli giornalieri sull'NQ sono GRATIS", "Smetti di copiare gli altri trader"], cta: "Segui per imparare azioni e futures",
    replicate: ["'I livelli sull'oro di oggi, gratis'", "La community come vantaggio"], exclude: ["Contaminazione col poker (diluizione fuori nicchia)"], note: "70k follower ma reach bassa: il poker disperde il focus." },
  { id: "cmp10", handle: "@goldpipssignal", role: "GOLD · CONTROESEMPIO", mark: "warn", virality: 15, conversion: 35, authority: 30, followers: "1k", verified: true, frequency: "alta", lang: "EN",
    types: ["Clip AI 5s", "Post generici"], pattern: "Contenuti AI generici + hashtag a raffica + fuori tema",
    hooks: ["Cos'è il Forex?", "12 verità sul mercato"], cta: "Commenta GOLD + link in bio",
    replicate: ["Nulla — è un modello di ciò che NON fare"], exclude: ["Clip 5s AI + spam di hashtag = 11-200 visualizzazioni nonostante verificato"], note: "Verificato + 1k follower ma reach morta: genericità + spam = zero." },
  { id: "cmp11", handle: "@goldtraderminko_", role: "CONTROESEMPIO · metriche vanità", mark: "warn", virality: 12, conversion: 20, authority: 15, followers: "42k", verified: true, frequency: "quotidiana", lang: "EN",
    types: ["Promo bot 8-17s"], pattern: "Caption identica 'GTM EA robot' su ogni singolo post",
    hooks: ["Prova il nostro sistema di trading automatico"], cta: "Link in bio (vendita bot)",
    replicate: ["Nulla"], exclude: ["42k follower ma ~3 like e ~600 visualizzazioni a post = audience comprata, engagement morto"], note: "Lezione: il numero di follower non è qualità. Grande vetrina, pubblico inesistente." },
  { id: "cmp12", handle: "@xauusdm1", role: "CONTROESEMPIO · funnel debole", mark: "warn", virality: 18, conversion: 30, authority: 25, followers: "7k", verified: false, frequency: "quotidiana", lang: "ES",
    types: ["Copy trade + espediente lotteria 'XAULOT'"], pattern: "Estrazione/montepremi + hashtag copy/telegram",
    hooks: ["XAULOT, il montepremi è a 63 $GRAM"], cta: "Copy trade + Telegram",
    replicate: ["Nulla (il funnel copy+Telegram è on-model ma non performa)"], exclude: ["Reach debole (51-1.009 visualizzazioni)", "Espediente lotteria"], note: "Funnel giusto sulla carta, esecuzione e reach deboli." },
  { id: "cmp13", handle: "@lorenzocorradofx", role: "AUTHORITY · Futures/SMC", virality: 44, conversion: 55, authority: 74, followers: "87.5k", verified: true, frequency: "quotidiana (live NY)", lang: "EN",
    types: ["Educativo SMC 41-67s", "COT / smart money"], pattern: "Concetti istituzionali (dati COT, smart money, livelli chiave, zone di domanda) su screen",
    hooks: ["Le istituzioni non tradano come ti hanno insegnato (dati COT)", "La maggior parte entra troppo presto — guarda qui"], cta: "E-book LTA gratuito (link in bio) + Day Trading live su NY",
    replicate: ["Angolo 'smart money/istituzionale' che dà autorevolezza", "Lead magnet gratuito (e-book) come funnel"], exclude: ["Reel 41-67s + gergo COT/istituzionale: barriera per principianti, reach schiacciata su 87k follower"], note: "87,5k follower ma reach modesta (best 14k visualizzazioni): tecnico-avanzato e reel lunghi. Autorevole, non virale." },
  { id: "cmp14", handle: "@jorge_torresfx", role: "MINDSET · GOLD-adjacent", country: "MX", virality: 28, conversion: 48, authority: 55, followers: "5.2k", verified: false, frequency: "quotidiana", lang: "ES",
    types: ["XAUUSD 3M short-form", "Psicologia / storytelling"], pattern: "XAUUSD short-form (19-25s) + mindset motivazionale, tono compliant ('non promettiamo guadagni')",
    hooks: ["Nessuno te ne parla quando inizi (psicologia)", "XAU/USD: il tuo lavoro non è indovinare, è adattarti"], cta: "Mentorship Metodo M35 (compliant)",
    replicate: ["Mix XAUUSD short-form + mindset emotivo (alta identificazione)", "Tono compliant 'insegniamo il processo, non promettiamo guadagni'"], exclude: ["Account piccolo (5k) e in spagnolo: reach bassa", "Qualche reel lungo (61s) che affossa la reach"], note: "Piccolo (5k) ma on-model: XAUUSD short-form + psicologia, in modo compliant. Buon esempio di TONO, non di reach." },
  { id: "cmp15", handle: "@gold_trader_su", role: "GOLD · REACH", mark: "star", virality: 92, conversion: 55, authority: 45, followers: "76.8k", verified: true, frequency: "a raffica", lang: "EN",
    types: ["Mindset/relatable 9-16s", "Frase-domanda + audio di tendenza"], pattern: "Frase relatable a schermo (scuola, scelte, vita) + #xauusd → reach virale, funnel Telegram in bio",
    hooks: ["La maestra aveva torto?", "Piano A o Piano B, quale sceglierai?"], cta: "Link in bio (Telegram) + commenta→DM via admin",
    replicate: ["Reel mindset ultra-corti (9-16s) taggati #xauusd come motore di reach iniziale", "Frase-domanda a schermo che ferma lo scroll ('Piano A o Piano B?')", "Bio compliant 'analisi gratis per principianti · precisione, non hype' + funnel Telegram"], exclude: ["Contenuto generico non-GOLD (mindset universale): reach altissima ma poco qualificata sul metodo oro", "Caption spoglie (#instagood #instagram): pubblico ampio ma non targettizzato XAUUSD"], note: "Scoperta Apify (13 Lug): macchina da reach GOLD-adjacent (76,8k, verificato). Reel 9-16s da 400k-877k visualizzazioni, uno con 66k like. Da rubare la MECCANICA di reach del mindset ultra-corto taggato XAUUSD, non il contenuto generico. Funnel Telegram in bio (analisi gratis per principianti)." },
  { id: "cmp16", handle: "@persaxu", role: "GOLD · AUTHORITY", mark: "star", country: "CO", virality: 84, conversion: 68, authority: 76, followers: "14.1k", verified: false, frequency: "incostante (pivot su tool)", lang: "EN",
    types: ["Educativo ICT/SMC 20-57s (sessioni, liquidità)", "Promo tool algoritmico (liqu.app)"], pattern: "UN concetto ICT/SMC sull'oro in short-form (sessione di NY, liquidità, ritracciamento di Londra) → reach virale + commenta→DM 'Commenta Gold'",
    hooks: ["Fai molta attenzione a questo (sessione PM di NY e liquidità)", "Commenta 'Gold' per ricevere The Blueprint"], cta: "Commenta→DM ('Commenta Gold/Profits') → Blueprint (corso a pagamento)",
    replicate: ["Educativo GOLD short-form su UN concetto tecnico (sessioni, liquidità, ritracciamento di Londra) reso semplice", "Commenta→DM 'Commenta ORO' come motore di conversione", "Reach virale (200k-536k) con oro tecnico ma accessibile"], exclude: ["Vendita di un 'Blueprint'/corso: noi siamo anti-guru con funnel Telegram GRATUITO", "Claim hype 'tool preciso al 100%' e 'segreti da 1M$' = non compliant", "Pivot recente sulla promo del proprio tool (liqu.app): reach crollata a poche centinaia di visualizzazioni"], note: "Scoperta Apify (13 Lug): vero educatore GOLD/XAUUSD (14,1k, CO). Reel 20-57s su ICT/liquidità/sessioni di NY da 213k-536k visualizzazioni (uno 18,6k like): prova che l'oro tecnico spiegato semplice in short-form sfonda, col commenta→DM. Prendere il format educativo+funnel, lasciare corso a pagamento e claim hype." },
  { id: "cmp17", handle: "@snipexau", role: "CONVERSION · NON COPIABILE", mark: "warn", country: "UK", virality: 30, conversion: 72, authority: 35, followers: "39.9k", verified: true, frequency: "quasi giornaliera", lang: "EN",
    types: ["Reel funnel 15-40s (commenta→DM)", "Short-form 'tradi con me'"], pattern: "Commenta→DM 'Commenta LIVE' su OGNI post → community / 1:1 live trading; hook 'tradi con me ogni giorno'",
    hooks: ["Fai queste 5 cose (Commenta 'live' per tradare live con me)", "E se funzionasse davvero?"], cta: "Commenta→DM 'Commenta LIVE' → community / 1:1 (Telegram in bio)",
    replicate: ["Commenta→DM disciplinato su OGNI post ('Commenta ORO') come motore di conversione", "I reel con VALORE ('Fai queste 5 cose') fanno ×3 la reach dei reel di sola-CTA: mettere sempre un contenuto, non solo l'invito"], exclude: ["Claim di reddito in bio ('Ho fatto 150.000+ il mese scorso') = zero compliance per noi e Meta, come moneymax", "Caption CTA identiche clonate su ogni post: uccidono reach/SEO", "Reach debolissima nonostante 39,9k verificato (reel 2k-15k visualizzazioni): il numero di follower verificato non è reach"], note: "Tracciato su richiesta (Apify 13 Lug): 39,9k, verificato, XAU-branded. Funnel commenta→DM ultra-disciplinato ('Commenta LIVE') ma bio con claim di reddito ('150k il mese scorso') = NON copiabile. Reach modesta (best 15k visualizzazioni). Prendere SOLO la meccanica del commenta→DM e il fatto che i reel con valore battono quelli di pura CTA." },
  { id: "cmp18", handle: "@callisto_fxtrades", role: "FOREX · FUNNEL", mark: "warn", virality: 45, conversion: 76, authority: 65, followers: "115k", verified: true, frequency: "quotidiana", lang: "EN",
    types: ["Reel educativi/relatable 14-45s", "Hook super-condivisibili ('Manda questo a...')"], pattern: "Educazione forex/XAUUSD short-form + hook condivisibile → funnel a community GRATUITA (121k) + 'Segui per il valore'; sistema multi-account con @madebynickolas/@madebyleonard",
    hooks: ["MANDA QUESTO ALL'AMICO CHE NON METTE MAI LO STOP", "Segui per altro valore"], cta: "Entra nella community GRATUITA (121k, Telegram) + segui per il valore",
    replicate: ["Hook condivisibile 'Manda questo a un amico che...' come leva di condivisione/reach", "Funnel a community GRATUITA come asset centrale (121k iscritti)", "Sistema multi-account: brand-madre + profili personali mindset che alimentano lo stesso funnel"], exclude: ["Claim di reddito in bio ('Da 100.000$ a 7M$ tradando LIVE') = non compliant per noi e Meta", "Riprova sociale gonfiata ('13.000 testimonianze')", "Reach modesta per la size (reel 5-7k visualizzazioni su 115k): il numero non è engagement"], note: "Tracciato su richiesta (Apify 13 Lug): 115k, verificato, educazione forex/XAUUSD. Grande macchina di funnel a community gratuita con hook condivisibili; bio con claim di reddito → NON copiabile nel framing. Da rubare l'hook 'manda questo a un amico' e il funnel a community, non il flex. NB: l'handle richiesto 'callistofx_trades' non esiste, quello reale è callisto_fxtrades." },
  { id: "cmp19", handle: "@madebynickolas", role: "MINDSET · personal brand", mark: "warn", virality: 18, conversion: 55, authority: 40, followers: "2.4k", verified: true, frequency: "quotidiana", lang: "EN",
    types: ["Carosello mindset/story", "Personal brand dietro il brand-madre"], pattern: "Mindset/storytelling personale ('il percorso da 100k$ a 7M$', 'prova sbaglia vinci', 'X errori') → umanizza il brand e spinge la stessa community gratuita di @callisto_fxtrades",
    hooks: ["10 errori che ti tengono povero nel trading", "Come vincere davvero nel trading"], cta: "Entra nella community GRATUITA (Telegram) + segui il percorso",
    replicate: ["Profilo personale 'mindset & vita' che umanizza il brand-madre e converte sullo stesso funnel", "Carosello 'X errori/lezioni' salvabile (esca al salvataggio) con CTA 'salva e rileggi dopo la prossima perdita'"], exclude: ["Claim di reddito '100k$ → 7M$' in bio (non compliant)", "Engagement debole (3-55 like su 2,4k verificato): personal brand ancora piccolo"], note: "Tracciato su richiesta (Apify 13 Lug): Nick (2,4k, verificato), 1 dei 2 founder di @callisto_fxtrades. Caroselli motivazionali/storytelling che umanizzano il brand. La lezione è il SISTEMA multi-account (brand-madre + personal brand sullo stesso funnel), non i numeri (piccoli)." },
  { id: "cmp20", handle: "@dovy.fx", role: "METALLI · REACH", virality: 80, conversion: 60, authority: 58, followers: "303k", verified: true, frequency: "quotidiana", lang: "EN",
    types: ["Carosello lifestyle aspirazionale", "Reel strategia occasionale (commenta→DM)"], pattern: "Lifestyle aspirazionale (jet, Dubai, 'la vita di un hybrid trader') come motore di reach → commenta→DM 'Commenta CVD' / DM 'READY' verso tool AI (hybridtrader.ai)",
    hooks: ["Commenta 'CVD' per imparare la strategia completa", "Credo di sapere una cosa che tu non sai"], cta: "Commenta→DM 'CVD' / DM 'READY' → hybridtrader.ai (tool AI)",
    replicate: ["Lifestyle come leva di reach — nel nostro caso SOBRIO, non flex: la vita dietro i mercati umanizza e attira", "Commenta→DM su una keyword ('Commenta ORO') verso il funnel", "Un post lifestyle può fare ×10-40 la reach di un post tecnico: alternare valore e vita"], exclude: ["Flex aspirazionale spinto (jet privati, 'raddoppia o niente'): fuori dal nostro tono compliant/sobrio", "Funnel a tool AI a pagamento invece che a community gratuita", "Non è GOLD-specifico (indici & metalli, per lo più lifestyle)"], note: "Tracciato su richiesta (Apify 13 Lug; l'handle reale è dovy.fx, non 'dovyfx'): 303k, verificato, indici & metalli (gold-adjacent). Reach enorme trainata dal LIFESTYLE (un carosello 547k like) più reel-strategia col commenta→DM. Rubare: il lifestyle come amplificatore di reach (ma sobrio) e il commenta→DM; lasciare il flex e il funnel-tool." },
  { id: "cmp21", handle: "@dovy.fxtrading", role: "FLEX/LIFESTYLE · NON COPIABILE", mark: "warn", virality: 25, conversion: 50, authority: 35, followers: "46.9k", verified: false, frequency: "dormante (post fermi al 2023)", lang: "EN",
    types: ["Flex/lifestyle 2023 (soldi, orologi, viaggi)", "Reel corti forex/stock options"], pattern: "Flex aspirazionale (mucchio di soldi, orologio da 80k$, Barcellona) + claim di reddito 'a 7 cifre' → link in bio a stock options/corso; account DORMANTE",
    hooks: ["È così che i ricchi su IG si fanno le foto?", "Serve un consiglio? Eccolo. Basta scuse."], cta: "Link in bio (dovyfx.com) → stock options / corso",
    replicate: ["Nulla di diretto: è il 'prima' flex di Dovy. Utile come CONTRASTO col profilo maturo @dovy.fx (303k), che ha spostato la reach su lifestyle sobrio + strategia"], exclude: ["Claim di reddito 'portafoglio a 7 cifre' + flex (orologio da 80k$, mucchio di soldi) = zero compliance", "Account dormante (post fermi al 2023): non è più un modello attivo", "Funnel a stock options/corso invece che a community gratuita"], note: "Tracciato su richiesta (Apify 13 Lug): account SECONDARIO e DORMANTE di Dovydas Pinskus (46,9k, non verificato, ultimi post 2023). Flex/lifestyle + claim di reddito 'a 7 cifre' + stock options → NON copiabile. Il suo profilo attuale e attivo è @dovy.fx (303k). Vale come controesempio del 'prima' flex vs il 'dopo' più maturo." },
  { id: "cmp22", handle: "@daytradergoldsister", role: "GOLD · NON COPIABILE", mark: "warn", country: "HK", virality: 18, conversion: 55, authority: 30, followers: "3k", verified: false, frequency: "incostante", lang: "ZH",
    types: ["Flex risultati + promo broker (Vantage)", "Post statici in cantonese"], pattern: "Day trading oro (HK) con flex risultati ('15 su 16, +15k$') + affiliate broker Vantage (codice referral, deposito 40k HKD) + funnel 'Gruppo VIP gratuito' Telegram",
    hooks: ["'Quanto è forte la strategia della Gold Sister?' (cantonese)", "'Oggi 15 su 16, +15.195$' (flex risultati)"], cta: "Gruppo VIP gratuito (Telegram) previo apri-conto broker con referral",
    replicate: ["Nulla di diretto: il funnel a community gratuita è on-model, ma qui è solo un veicolo per l'affiliazione broker e il flex"], exclude: ["Flex risultati ('+15.195$', 'capitale raddoppiato') = claim di reddito non compliant per noi e Meta", "Affiliate broker (Vantage, codice referral, deposito 40k HKD): conflitto d'interesse, off-model", "Reach/engagement bassissimi (0-40 like su 3k): il funnel spinto non genera community reale"], note: "Tracciato su richiesta (Apify 13 Lug): day trader oro di Hong Kong (3k, cantonese). GOLD-focused ma modello NON copiabile: flex risultati + affiliate broker Vantage + gruppo VIP, engagement morto. Conferma che flex+affiliate non è la strada; noi restiamo educativi/compliant col funnel Telegram gratuito." },
];
